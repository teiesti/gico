...
BACKUP_DIR=$DIR/backup/$(date +%F_%T)	# path where existing but deprecated resources with the same name were backed up
...
REPO_VERSION="v1.0.0-rc2"				# version of the configuration repository
